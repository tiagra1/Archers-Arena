...
class Control(BaseControl):
    ...
    def pregame_control(self, engine, keys, newkeys, buttons, newbuttons, mouse_position):
        ...
        if pygame.K_d in newkeys:
            ...
            self.set_state(CONTROL_STATE_WANT_SELECT)
        return

    def selection_control(self, engine, keys, newkeys, buttons, newbuttons, mouse_position):
        #controls the map select
       
        if pygame.K_i in newkeys:
            pass
        elif pygame.K_j in newkeys:
            pass
        elif pygame.K_k in newkeys:
            pass
        elif pygame.K_l in newkeys:
            pass
    ...
    def game_input_control(self, engine, keys, newkeys, buttons, newbuttons, mouse_position):
        ...
        if pygame.K_UP in newkeys and pygame.K_LEFT in newkeys:
            engine.set_missile_direction(225)
            engine.fire_missile()
            moving = False

        elif pygame.K_UP in newkeys and pygame.K_RIGHT in newkeys:
            engine.set_missile_direction(315)
            engine.fire_missile()
            moving = False

        elif pygame.K_DOWN in newkeys and pygame.K_RIGHT in newkeys:
            engine.set_missile_direction(45)
            engine.fire_missile()
            moving = False

        elif pygame.K_DOWN in newkeys and pygame.K_LEFT in newkeys:
