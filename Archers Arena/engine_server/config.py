...
PLAYER_SPEED_STOP   = (3000.0,  XP_LEVELS[XP_LEVEL_0])
PLAYER_SPEED_SLOW   = (3000.0, XP_LEVELS[XP_LEVEL_0])
PLAYER_SPEED_MEDIUM = (3000.0, XP_LEVELS[XP_LEVEL_SPEED_MEDIUM])
PLAYER_SPEED_FAST   = (80.0, XP_LEVELS[XP_LEVEL_SPEED_FAST])
